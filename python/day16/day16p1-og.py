...
def solve(current_node: str, time: int, enp: str) -> list[int]:
    ...
    # if current_node not in enabled_nodes:
    ...
    for connected_node in [current_node] + NETWORK[current_node]:
        ...
        solution = [rate] + solve(connected_node, time+1, pack_nodes(new_nodes))
